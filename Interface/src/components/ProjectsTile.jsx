  ...
  return (
    <>
        ...
        <div className={styles.tile}>
          ...
          {user.userData.role === 3 && (
            <button className={`btn btn-primary ${styles.gAplikuj}`} onClick={handleApplicationClick}>Aplikuj</button>
          )}
          {user.userData.role === 2 && (
            <button className={`btn btn-primary ${styles.gAplikuj}`} onClick={() => handleSupportClick(project.id)}>
